...
describe('ProductService', () => {
  ...
  it('should retrieve all products from API via GET', () => {
    ...
    const req = httpTestingController.expectOne(`${service['backendUrl']}/products/`)
  ...
  it('should retrieve newest products from API via GET', () => {
    ...
    const req = httpTestingController.expectOne(`${service['backendUrl']}/newest-products/`)
    expect(req.request.method).toBe('GET')
  ...
  it('should retrieve bestselling products from API via GET', () => {
    ...
    const req = httpTestingController.expectOne(`${service['backendUrl']}/bestselling-products/`)
    expect(req.request.method).toBe('GET')
