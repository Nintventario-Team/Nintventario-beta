...
describe('UserDetailsComponent', () => {
  ...
  beforeEach(async () => {
    const authServiceSpy = jasmine.createSpyObj('AuthService', ['checkLoginStatus', 'getUserInfo', 'logout'])
  ...
  describe('ngOnInit', () => {
    ...
    it('should log error if user info cannot be fetched', fakeAsync(() => {
      authService.checkLoginStatus.and.returnValue(true)
      authService.getUserInfo.and.returnValue(throwError('User info fetch error'))
      ...
      expect(console.error).toHaveBeenCalledWith('Error fetching user info:', 'User info fetch error')
    }))
